...
[general]
excluded_routes=192.168.1.0/24, 172.16.0.0/12, 100.64.0.0/10, 10.0.0.0/8
...
; DNS 规则需要通过远程文件或手动添加到配置中
; 请参考仓库中的 QuanX_DNS_Rules.conf 文件
; 或在 Quantumult X 中使用远程资源功能:
; 资源 > 远程文件 > 添加
; URL: https://raw.githubusercontent.com/init-object/ClashCustomRule/master/QuanX_DNS_Rules.conf
